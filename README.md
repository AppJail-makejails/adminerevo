...
* `adminerevo_tag` (default: `13.5-php82-apache`): See [#tags](#tags).
* `adminerevo_ajspec` (default: `gh+AppJail-makejails/adminerevo`): Entry point where the `appjail-ajspec(5)` file is located.
